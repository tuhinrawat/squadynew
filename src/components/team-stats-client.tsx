                      ...
                      filteredPlayerCards.map(card => (
                            ...
                            >
                              ...
                              <div className="absolute top-2 right-2 sm:top-3 sm:right-3 z-20">
                                <Badge 
                                  variant="secondary" 
                                  className={`${card.isBidder ? 'bg-violet-200 text-violet-950 border border-violet-300' : 'bg-white/10 text-white'} backdrop-blur px-2 py-1 text-[9px] sm:text-xs font-bold`}
                                >
                                  {card.statusLabel}
                                </Badge>
                              </div>
